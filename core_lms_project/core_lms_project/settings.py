"""
Django settings for core_lms_project project.
...
SECRET_KEY = "django-insecure-og@oxj8(4nmrlx)zx81##60o9oe-5tmj=$lw7r6&o-hpls_#cl"
...
# Optional: Ensure the login redirect URL is set correctly
LOGIN_REDIRECT_URL = '/api/teacher/'
...
ROOT_URLCONF = "core_lms_project.urls"
